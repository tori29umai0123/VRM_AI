    ...
    public class Vrm10Importer : UniGLTF.ImporterContext
    {
        ...
        VRM10Expression GetOrLoadExpression(in SubAssetKey key, ExpressionPreset preset, UniGLTF.Extensions.VRMC_vrm.Expression expression)
        {
            ...
            if (m_externalMap.TryGetValue(key, out UnityEngine.Object expressionObj))
            {
                ...
                clip.OverrideBlink = UniGLTF.Extensions.VRMC_vrm.ExpressionOverrideType.blend;
                clip.OverrideLookAt = UniGLTF.Extensions.VRMC_vrm.ExpressionOverrideType.blend;
                clip.OverrideMouth = UniGLTF.Extensions.VRMC_vrm.ExpressionOverrideType.blend;
            }
            else
            {
                if (expression == null)
                {
                    ...
                    {
                        IsBinary = false,
                        OverrideBlink = UniGLTF.Extensions.VRMC_vrm.ExpressionOverrideType.blend,
                        OverrideLookAt = UniGLTF.Extensions.VRMC_vrm.ExpressionOverrideType.blend,
